...
import type { ButtonTag, Block, Color, Filter, Rounded, Size, Variant } from './button-types'
import type { TwClassInterface } from '@/interfaces/interfaces'
...
</template>../../../composables../../../composables../../../interfaces/interfaces