            ...
            <div class="flex flex-wrap justify-center w-full flex-col items-center">
                <div class="flex items-center mb-6">
                    ...
                    <div class="h-16 w-16 rounded-full bg-gray-100 overflow-hidden border shadow-sm">
                        <img height="64" width="64" class="h-full w-full object-cover" :src="detail?.author_photo"/>
                    </div>

                    <div class="pl-2 text-left">
                        <span class="block font-aeonik font-medium text-xl" v-text="detail?.author_full_name"/>
